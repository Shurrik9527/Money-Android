package com.moyacs.canary.widget.pullrefreshlayout;
...
public class ClassicsHeader extends NestedRelativeLayout implements PullRefreshLayout.OnPullListener {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        //设置释放立即刷新的颜色
        mHeaderText.setTextColor(ContextCompat.getColor(getContext(), R.color.black));
        mHeaderText.setTextSize(16);
        //最后刷新时间
        mLastUpdateText = new TextView(context);
        mLastUpdateText.setTextColor(ContextCompat.getColor(getContext(), R.color.black));
        ...
        mArrowDrawable.parserColors(0xff000000);
        mArrowDrawable.parserPaths("M20,12l-1.41,-1.41L13,16.17V4h-2v12.17l-5.58,-5.59L4,12l8,8 8,-8z");
        mArrowView.setImageDrawable(mArrowDrawable);


        mProgressDrawable = new ProgressDrawable();
        mProgressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.black));
